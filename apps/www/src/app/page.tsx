      ...
      <Container className="flex flex-col justify-between gap-8 py-4">
        <div className="flex flex-col md:flex-row gap-12 justify-center items-center">
          <div className="md:w-1/2 flex flex-col gap-4 items-start">
            <p className="text-2xl merienda"> Hi! I'm Joel Samuel 👋🏼 </p>
            <div className="w-4/5 h-1 bg-primary"></div>
            <p className="text-xl leading-normal"> <span className="merienda text-primary underline"> "Generative"</span> AI Engineer,<br /> Javascript Developer: <span className="merienda text-primary underline"> "FullStack"</span> </p>
            <p className="text-subtext0 font-light"> Self taught programmer, FOSS Enthusiast and Contributor, <span className="text-primary font-normal"> Jack of many trades. </span></p>
            <ContactButtons />
            <div>
